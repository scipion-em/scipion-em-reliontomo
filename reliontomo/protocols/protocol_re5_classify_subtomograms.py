...
from reliontomo.convert.convert50_tomo import OPTICS_TABLE, PARTICLES_TABLE
...
class ProtRelion5ClassifySubtomograms(ProtRelion5RefineSubtomograms):
    ...
    def _defineOptimisationParams(self, form):
        ...
        self._insertRegularisationParam(form, defaultVal=1)
    ...
    def _insertAllSteps(self):
        ...
        self._insertFunctionStep(self.classify3d)
    ...
    def createOutputStep(self):
        inParticlesPointer = self.inReParticles

        # Link the particles file generated (_data.star) to follow the name convention
        createLink(self._getIterGenFileName('data', self.nIterations.get()),
                   self._getExtraPath(OUT_PARTICLES_STAR))
        ...
        self._defineSourceRelation(inParticlesPointer, relionParticles)
        ...
        #     averages.append(vol)
        self._defineOutputs(**{outputObjects.classes.name: classes3D})
    ...
    def _loadClassifyInfo(self, iteration):
        ...
        self.nClasses = self.numberOfClasses.get()
