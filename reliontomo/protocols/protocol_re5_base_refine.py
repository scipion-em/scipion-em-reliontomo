...
class ProtRelion5RefineBase(ProtRelion5TomoBase):
    ...
    def _defineCTFParams(form):
        ...
        form.addParam('doCTF', BooleanParam,
                      ...
                      help='If set to Yes, CTFs will be applied to the projections of the map inside the MAP '
                           'refinement. The resulting algorithm intrinsically implements the optimal linear, '
                           'or Wiener filte. Note that input particles should contain the CTF parameters.')
    ...
    def _defineAdditionalParams(self, form):
        ...
        self._defineExtraParams(form, addAdditionalSection=False)
